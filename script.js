const questionList = [
    {
        subtitle: '👩‍💻 领域简介 & 常用技术',
        questions: ['前端/全栈开发在科技行业是怎样被广泛应用的？我们为什么要学习TA？', '前端开发和全栈开发有什么区别？作为前端工程师, 我该怎样提升自己走向全栈？', '作为一名前端/全栈开发工程师, 需要掌握的技术都分别有什么？'],
    },
    {
        subtitle: '👩‍💻 个人项目 & 学习路径',
        questions: ['为什么说个人项目对于前端/全栈开发工程师非常重要？','请分享一下你的个人项目和使用的技术栈！', '为了个人项目你学习了什么新技术，又是怎样把已掌握的技术应用起来的？'],
    },
    {
        subtitle:'👩‍💻 资源分享 & 使用建议',
    ...
    },
    {
        subtitle: '👩‍💻 面试准备 & 常见问题',
        questions:[
        '前端/全栈开发工程师面试与其它SDE岗位面试有何异同？','你所在公司的面试流程是怎样的？常见的面试问题都有什么？', '刷题之外, 我该如何准备前端/全栈工程师面试？']
    }
